...
class segment {
  public:
    size_t index;
    std::string data;
    segment(size_t _index, std::string _data) : index(_index), data(_data) {}
...
class StreamReassembler {
  ...
  public:
    ...
    int merge(size_t &index, std::string &data, std::set<segment>::iterator iter2);
    ...
    size_t first_unassembled_byte() const { return first_unassemble; }
